...
const profileElement2 = document.getElementById('profile2');
if (profileElement) {
    profileElement.textContent = username;
}
if (profileElement2) {
    profileElement2.textContent = username;
}
...
const count_item2 = document.querySelector(".count_item2");
